...
- Create Angular project with ng: `ng new recruitmentplatform.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`recruitmentplatform.client.esproj`).
